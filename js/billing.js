...
document.getElementById("generateBillBtn")?.addEventListener("click", async (e) => {
  e.preventDefault();

  // You can add your Firestore billing logic here
  // Example: store name, plan, amount

  // After bill is successfully created
  alert("Bill generated successfully!");
